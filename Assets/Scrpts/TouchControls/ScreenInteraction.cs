...
public class ScreenInteraction
{
    ...
    public ScreenInteractionController.ITouchable touchable;
    ...
    ///if screenPositionPolled.Count is larger than one, use the last item in the list in screenPositionsPolled, otherwise user screenPositionStart
    ///[^1] gives you the last index of a collection, [^2] gives you the second last, etc
    ///<summary>
    ///Returns the current position of the screen interaction
    ///</summary>
    public Vector3 ScreenPositionCurrent => screenPositionsPolled.Count > 1 ? screenPositionsPolled[^1] : screenPositionStart;
    ...
    public bool TryAddTouchable(ScreenInteractionController.ITouchable touchable)
    {
    ...
    public class Tap
    {
        ...
        public static bool Try(ScreenInteraction screenInteraction, out Tap tap)
        {
            ...
            //otherwise, we have a valid tap, so contruct one
